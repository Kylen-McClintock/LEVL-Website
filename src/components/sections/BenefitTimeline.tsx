...
export function BenefitTimeline() {
    return (
        <BentoCard colSpan={4} className="p-8 md:p-12 bg-brand-dark/50 border-white/10 relative overflow-hidden">
            {/* Background Image */}
            <div className="absolute inset-0 z-0">
                <Image
                    src="/images/running-lifestyle.jpg"
                    alt="Active Lifestyle"
                    fill
                    className="object-cover opacity-10 grayscale hover:grayscale-0 transition-all duration-700 ease-in-out"
                />
