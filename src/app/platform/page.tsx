            ...
            <Container>
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="bg-[var(--color-levl-panel)] border border-[var(--color-levl-panel-border)] rounded-3xl backdrop-blur-xl shadow-2xl group flex flex-col md:flex-row overflow-hidden">
                        ...
                        <div className="h-64 md:h-auto md:w-2/5 bg-[url('/images/platform-visual-2.png')] bg-contain bg-no-repeat bg-center opacity-90 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-screen" style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 70%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 70%)' }} />
                    </div>
                </div>
            </Container>
        </section>
            ...
            <Container>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="md:col-span-1 bg-[var(--color-levl-panel)] border border-[var(--color-levl-panel-border)] rounded-3xl backdrop-blur-xl transition-colors group flex flex-col overflow-hidden hover:border-white/20">
                        <div className="h-48 w-full bg-[url('/images/literature_engine_visual.png')] bg-contain bg-no-repeat bg-center opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-screen" style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 70%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 70%)' }} />
                    ...
                    <div className="md:col-span-2 bg-[var(--color-levl-panel)] border border-[var(--color-levl-panel-border)] rounded-3xl backdrop-blur-xl overflow-hidden group flex flex-col md:flex-row hover:border-white/20 transition-colors">
                        ...
                        <div className="h-64 md:h-auto md:w-1/2 bg-[url('/images/platform-visual.png')] bg-contain bg-no-repeat bg-center opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-screen" style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 70%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 70%)' }} />
                    </div>
                    ...
                    <div className="md:col-span-3 bg-gradient-to-r from-[var(--color-levl-panel)] to-black/40 border border-[var(--color-levl-panel-border)] rounded-3xl backdrop-blur-xl overflow-hidden group flex flex-col md:flex-row hover:border-white/20 transition-colors">
                        ...
                        <div className="h-64 md:h-auto md:w-1/2 bg-[url('/images/synergy_engine_visual.png')] bg-contain bg-no-repeat bg-center opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-screen" style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 70%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 70%)' }} />
                    </div>

                    {/* Protocol App */}
                    <div className="md:col-span-2 bg-[var(--color-levl-panel)] border border-[var(--color-levl-panel-border)] rounded-3xl backdrop-blur-xl overflow-hidden group flex flex-col md:flex-row hover:border-white/20 transition-colors">
                        <div className="h-64 md:h-auto md:w-1/2 bg-[url('/images/protocol_app_visual.png')] bg-contain bg-no-repeat bg-center opacity-90 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-screen" style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 70%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 70%)' }} />
                        <div className="p-8 flex flex-col justify-center md:w-1/2">
                    ...
                    {/* Feedback Loop */}
                    <div className="md:col-span-1 bg-[var(--color-levl-panel)] border border-[var(--color-levl-panel-border)] rounded-3xl backdrop-blur-xl transition-colors group flex flex-col overflow-hidden hover:border-white/20">
                        <div className="h-48 w-full bg-[url('/images/feedback_loop_visual.png')] bg-contain bg-no-repeat bg-center opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 mix-blend-screen" style={{ maskImage: 'radial-gradient(circle, black 50%, transparent 70%)', WebkitMaskImage: 'radial-gradient(circle, black 50%, transparent 70%)' }} />
                        <div className="p-8 flex-grow">
                            <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mb-6 group-hover:bg-[var(--color-levl-cyan)]/10 transition-colors">
