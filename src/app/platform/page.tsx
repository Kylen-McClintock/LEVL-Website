        ...
        <section className="py-24 border-t border-white/5 relative overflow-hidden">
            ...
            <Container>
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 md:order-2 space-y-12 flex flex-col justify-between">
                        {/* Bridge */}
                        <div>
                        ...
                        <div className="bg-[var(--color-levl-panel)] border border-[var(--color-levl-panel-border)] p-8 rounded-3xl shadow-xl relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                <h3 className="text-2xl font-bold text-white">LIFESPAN+ Activate</h3>
                                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[var(--color-levl-cyan)]/30 bg-[var(--color-levl-cyan)]/10 text-[var(--color-levl-cyan)] text-[10px] font-bold tracking-widest uppercase w-fit">
                                    <ShieldCheck className="w-3.5 h-3.5" />
                                    Patented US 12396994 B2
                                </div>
                            </div>
                            <p className="text-[var(--color-levl-cyan)] font-medium mb-6">Targeted autophagy and cellular clearance.</p>
                            
                            <p className="text-[var(--color-levl-text-secondary)] text-sm leading-relaxed mb-4">
                                The first patent from the LEVL platform is a synergistic combination of 3 ingredients that combined induces comparable levels of autophagy as Rapamycin without the negative immune suppressing side effects.
                            </p>
                            <p className="text-white/60 text-sm leading-relaxed">
